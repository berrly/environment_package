...
import tool from '../model/tool';
  export default {
	...
	beforeMount(){
		let userInfo=tool.storage.get('userInfo');
		if(userInfo){
    ...
    methods: {
      getAreaSeries(){
			 ...
			 var userinfo=tool.storage.get('userinfo');
              ...
              var api=tool.config.apiUrl+'index.php?m=Api&a=areaOptions&uid='+userinfo.id+'&sign='+sign;
		...
		getColumnSeries(){
			 ...
			 var userinfo=tool.storage.get('userinfo');
              ...
              var api=tool.config.apiUrl+'index.php?m=Api&a=columnOptions&uid='+userinfo.id+'&sign='+sign;
	  ...
	  doLogin(){
		  if(this.userinfo.username && this.userinfo.password){
				...
				this.$http.post(tool.config.apiUrl+'index.php?m=Api&a=login', {
				...
				.then((response)=>{
					...
					if(response.success){
							...
							tool.storage.set('userinfo',response.result);
